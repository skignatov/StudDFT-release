...
Version 1.29.8 is the newer release having much more capabilities and appropriate corrections. See `StudDFT_Short_Manual_<version>.pdf` for new capabilities.
